...
public class unfindOrderServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(userId==null){
			request.setAttribute("msg", "ç™»å½•æ—¶é—´è¶…æ—¶ï¼Œè¯·é‡æ–°ç™»å½•");
		...
		if(bookorder ==null){
			System.out.println("åœ¨unfinishedé‡Œé¢ï¼šæ²¡æœ‰èŽ·å–è®¢å•");
		}
		if(bookorder !=null){
		...
		for(int i=0;i<bookorder.size();i++){
			System.out.println("åœ¨servleté‡Œé¢ï¼Œæµ‹è¯•ï¼š"+bookorder.get(i).toString());
